  ...
  <page-container title="文章管理">
    ...
    <el-table  v-loading="loading" :data="articleList" style="width: 100%;">
      ...
      <el-table-column label="操作" width="150">
        <template #default="{ row }">
          <el-button :icon="Edit" type="primary" plain circle @click="editArticle(row)"></el-button>
          <el-button :icon="Delete" type="danger" plain circle @click="deleteArticle(row)"></el-button>
        </template>
      </el-table-column>
    ...
    />
    <ArticleEdit ref="drawer" @success="handelSuccess"></ArticleEdit>
  </page-container>
</template>
